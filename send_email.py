...
def extract_summary(file_path="C:/SyabaruddinFolder/Work/Algoritma/DATAANALYTICScourse/dataanalysis/CAPSTONE-PROJECT/fire-capstone-master/fire-capstone-master/data_input/data.csv", id=['936','1178']):
  """   
...
def compose_email(template, name, data_dict):
  ...
  composed = template.substitute(
    ...
    GITHUB_LINK='https://github.com/syabaruddin/email-auto-using-flask'
  )
  return composed
